...
def upgrade() -> None:
    ...
    # create enum first
    auth_provider_enum = sa.Enum("GOOGLE", "APPLE", "EMAIL", name="authprovider")
    ...
    op.create_index(
        "uix_provider_user", "auth_accounts", ["provider", "user_id"], unique=True
    )
...
def downgrade() -> None:
    ...
    sa.Enum("GOOGLE", "APPLE", "EMAIL", name="authprovider").drop(
